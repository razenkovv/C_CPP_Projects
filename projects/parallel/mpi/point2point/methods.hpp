...
struct ProcessInfo {
 public:
  ...
  ProcessInfo() : height_(0), width_(0), row_size_(0), count_(0) {}
  ProcessInfo(unsigned int height, unsigned int width, unsigned int row_size, unsigned int count) : height_(height), width_(width), row_size_(row_size), count_(count) {}
};